...
public class Main {
	...
	public void subMian() {
		...
		do {
			...
			case 1:
				System.out.println("***Enter the File Name to create new file1:***");
			...
			case 4:
				...
				String filename = scan.nextLine();
				try {
					boolean success = lockedMeBOI.getFileByName(filename).equals(filename);
	...
	public static void main(String[] args) {
		System.out.println("\t\t\t\tWelcome to LockedMe.com V1.2");
		System.out.println();
